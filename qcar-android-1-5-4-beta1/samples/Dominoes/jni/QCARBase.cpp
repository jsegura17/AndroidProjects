...
Java_com_qualcomm_QCARSamples_Dominoes_Dominoes_getOpenGlEsVersionNative(JNIEnv *, jobject)
{
#ifdef USE_OPENGL_ES_1_1        
    return 1;
#else
...
JNIEXPORT void JNICALL
Java_com_qualcomm_QCARSamples_Dominoes_Dominoes_startCamera(JNIEnv *,
                                                                         jobject)
{
...
Java_com_qualcomm_QCARSamples_Dominoes_Dominoes_toggleFlash(JNIEnv*, jobject, jboolean flash)
{
