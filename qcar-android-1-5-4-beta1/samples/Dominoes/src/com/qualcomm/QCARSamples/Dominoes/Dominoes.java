...
public class Dominoes extends Activity
{
    ...
    {   
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            else
            {
                ...
                AlertDialog dialogError = new AlertDialog.Builder(Dominoes.this).create();
    ...
    {
        mTextures.add(Texture.loadTextureFromApk("texture_android.png", getAssets()));
        mTextures.add(Texture.loadTextureFromApk("green_glow.png", getAssets()));
        mTextures.add(Texture.loadTextureFromApk("blue_glow.png", getAssets()));
    }
