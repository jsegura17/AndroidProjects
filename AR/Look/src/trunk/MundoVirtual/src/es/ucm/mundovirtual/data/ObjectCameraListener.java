...
public class ObjectCameraListener implements CameraListener{

	@Override
	public void onCameraEntered(WorldEntity entity) {
		TextView tv = (TextView) LookARUtil.getApp().findViewById(R.id.mensaje);
		tv.setText(entity.getData().getPropertyValue("message"));
