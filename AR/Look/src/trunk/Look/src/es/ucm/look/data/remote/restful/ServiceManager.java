...
public class ServiceManager {
	...
	public IRemoteService restfulService;
	...
	public class RestfulServiceConnection implements ServiceConnection {
		...
		public void onServiceConnected(ComponentName className,
			...
			restfulService = IRemoteService.Stub
	...
	private IRemoteServiceCallback mCallback = new IRemoteServiceCallback.Stub() {
		...
		@Override
		public void sendResponse4(String result) throws RemoteException {
			if (mHandler != null)
				mHandler.sendMessage(mHandler.obtainMessage(
						LookProperties.ACTION_GET_PROPERTIES_USER, result));
		}
	};
