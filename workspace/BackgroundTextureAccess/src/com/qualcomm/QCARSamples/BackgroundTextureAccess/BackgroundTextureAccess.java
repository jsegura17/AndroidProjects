...
package com.qualcomm.QCARSamples.BackgroundTextureAccess;
...
/** The main activity for the BackgroundTextureAccess sample. */
public class BackgroundTextureAccess extends Activity
{
    ...
    private static final String NATIVE_LIB_SAMPLE = "BackgroundTextureAccess";
    ...
    {   
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            {
                QCAR.setInitParameters(BackgroundTextureAccess.this, mQCARFlags);
                do
                {
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            else
            {
                ...
                AlertDialog dialogError = new AlertDialog.Builder(BackgroundTextureAccess.this).create();
    ...
    {
        DebugLog.LOGD("BackgroundTextureAccess::onCreate");
        super.onCreate(savedInstanceState);
        
        // Set the splash screen image to display during initialization:
        mSplashScreenImageResource = R.drawable.splash_screen_background_texture_access;
   ...
   /** Called when the activity will start interacting with the user.*/
    ...
    {
        DebugLog.LOGD("BackgroundTextureAccess::onResume");
        super.onResume();
    ...
    {
        DebugLog.LOGD("BackgroundTextureAccess::onPause");
        super.onPause();
    ...
    {
        DebugLog.LOGD("BackgroundTextureAccess::onDestroy");
        super.onDestroy();
    ...
    public boolean onTouchEvent(MotionEvent event)
    {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK)
        {
            ...
            case MotionEvent.ACTION_UP:
                nativeTouchEvent(-100, -100);
                break;
            case MotionEvent.ACTION_POINTER_UP:
                nativeTouchEvent(-100, -100);
                break;
            case MotionEvent.ACTION_DOWN:
                x = event.getX(0) / mScreenWidth;
                y = event.getY(0) / mScreenHeight;
     ...
     * access by BackgroundTextureAccess::onResume() and InitQCARTask::onPostExecute(). */
    ...
    {        
        ...
        mRenderer = new BackgroundTextureAccessRenderer();
